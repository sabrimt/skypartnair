<?php
/**
 * Description of Privatejet
 *
 * @author Pierre-Antoine
 */

class Privatejet extends CI_Controller {
...
//		$this->output->enable_profiler(TRUE);
	...
	public function index() {
		...
		$this->layout->view('privatejet', $data);
	}
...
//		$lng = $this->lang->lang();
		...
		if($this->email->send()){
			...
			redirect(base_url('privatejet') ,'location');
		}else{
			$this->session->set_flashdata("email_sent", t("privatejet_lang_email_error"));
//			show_error($this->email->print_debugger());
			redirect(base_url('privatejet/freequote') ,'location');
		}
