...
class Blog extends CI_Controller {
	...
	public function listDisplay($cat = "") {
		...
		$data['artitre'] = $this->artMgr->articleList("article_date desc", ['limit'=>1, 'start'=>0], $cat );
		$data['articles'] = $this->artMgr->articleList("article_date desc", ['limit'=>9, 'start'=>1], $cat );
		$data['voiraussi'] = $this->artMgr->articleList("article_date desc", ['limit'=>100, 'start'=>10], $cat );
