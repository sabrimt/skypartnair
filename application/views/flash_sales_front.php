...
<section class="row liste-ventes" style="background-color: #FAFAFA; margin-bottom: 0;">
	<div class="col l8 s12 offset-l2" style="padding-left:2rem;">
		...
		<h2><?= t("flash_lang_1p") ?> Nos meilleurs ventes flash avec les meilleurs avions du monde etc etc .... </h2>
		<p>blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla blabla </p>
    ...
    <div class="col l10 s12 offset-l1" >
        <ul class="sales-list move-list collapsible popout" data-collapsible="accordion" style="margin-top: 1rem; margin-bottom: 2rem; border: none!important; ">
            ...
            <h3 style="padding-left:2rem;"><?= t("flash_lang_h3_sorry") ?> </h3>
                ...
                ?> 
            <h3 style="padding-left:2rem;"> <?= $nb_sale ?><?= t("flash_lang_h3_sale") ?><?=$s?><?= t("flash_lang_h3_sale_av") ?><?=$s?> </h3>
			<div class="row">
			...
			<?php	} ?>
				...
				$dispo_complete = $sale->to_date != $sale->from_date && $sale->to_date != "" ? '<small>' . t("flash_lang_from") . '</small>' . $sale->from_date . '&nbsp;&nbsp;<small>' . t("flash_lang_to") . '</small>&nbsp;&nbsp;' . $sale->to_date : t("flash_lang_the") . $sale->from_date;
			?>
                ...
                <div class="row collapsible-header hoverable" style="padding-top:1rem;">
                    <div class="sale-infos-form col l3 m4 s12" data-sale="<?= $sale->id ?>">
                            ...
                            <div class="left-align">
                                ...
                                <span><strong><?= $dispo_complete ?></strong></span>
                            </div>
                    </div>
					...
					<div class="col l7 m8 s12 flex-container">
						...
						<div class="col l2 m3 s3 pull-s6 valign-wrapper space-around">
							<div class="center">
								<span class="valign-wrapper space-around" style="font-size:14pt;"> <i class="material-icons">&#xE637;</i><strong><?= $sale->capacity ?></strong></span>
	...
	<div class="hide">
		...
		<div class="row">
			...
			<div class="col l2 s12">
				...
				<a class="btn waves-effect waves-light center-align blue lighten-7 show-btn valign-wrapper" data-sale-index="<?= $sale_index ?>">
						   <?= t("flash_lang_details") ?>
				</a>
				</div>
				<div class="col s12">
				<button class="btn waves-effect waves-light btn-large blue darken-6" type="submit" name="send" value="<?= set_value("send") ?>" style="width:100%; margin-top:5.5rem;">
						   <?= t("flash_lang_send") ?>
				</button>
				</div>
			</div>
...
<section class="row txt-ventes blue-grey lighten-5" style="margin-bottom: 0;">
	...
	<div class="col l10 s12 offset-l2 blue-grey lighten-5" style="margin-top: 0; padding-bottom: 3rem;">
		<p><?= t("flash_lang_p4") ?><strong>MK Partnair</strong> <?= t("flash_lang_p41") ?><br/>
		<?= t("flash_lang_p42") ?></p>
		<p><?= t("flash_lang_p5") ?><a href="+33 1 84 24 03 94">+33 1 84 24 03 94</a> <?= t("flash_lang_p51") ?></p>
