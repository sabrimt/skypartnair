...
<section id="focus-content" class="row liste-ventes" style="background-color: #FAFAFA; margin-bottom: 0;">
	...
	<div class="col l10 s12 offset-l1" >
		<ul class="sales-list move-list collapsible popout" data-collapsible="accordion" style="margin-top: 1rem; margin-bottom: 2rem; border: none!important; ">
			...
			<div id="error-scroll-target" class="row">

				<h2 class="red-text text-darken-4" style="width: max-content; margin: 1.3rem auto;">
					<strong><i class="material-icons left">error_outline</i><?= t('flash_lang_form_errors_label'); ?></strong>
				</h2>
				<?php
					$errors_open_tag = "<em class='block col m8 offset-m2 s10 offset-s1 valign-wrapper grey lighten-2' style='border-left: 4px solid #9B3532; padding-bottom: 1px; padding-top: 1px;'><i class='material-icons red-text text-darken-3 left' style='font-size: 1.2rem;'>error</i>";

					echo validation_errors($errors_open_tag, "</em>");
				?>

				<div class="col m8 offset-m2 s10 offset-s1 valign-wrapper grey lighten-2" style="border-left: 4px solid #9B3532;">
					<a href="#active-item" class="btn active-item-link red darken-5 js-scrollTo"><?= t("flash_lang_complete_form") ?></a>
				</div>
				...
				<div class="row collapsible-header hoverable" style="padding-top:1rem;">
					...
					<div class="col l7 m8 s12 flex-container">
						...
						<div class="col l2 m3 s3 pull-s6 valign-wrapper space-around">
							<div class="center">
								<span class="valign-wrapper space-around" style="font-size:14pt;"> <i class="material-icons">&#xE637;</i><strong><?= $sale->capacity ? $sale->capacity : $sale->fleet->passengers; ?></strong></span>
					...
					<div class="header-aircraft-details row">
						<div class="header-aircraft-details-content col s12">
							<div class="detail-photos col l8 m6 s4">
							...
							<div class="col l4 m6 s8 details-content">
	...
	<div class="hide">
		...
		?>
				...
				<div class="col l10 s12">
					...
					<div class="row">
						<div class="input-field col l6 s12 valign-wrapper">
							...
							. form_label("Email", "email", ["class"=>"active",]);
							?>
					</div>
					<div class="input-field col l5 s12 valign-wrapper">
						...
						. form_label(t("flash_lang_phone"), "phone", ["class"=>"active",]);
						?>
					</div>
				</div>
				<div class="row">
			...
			<div class="col l2 s12">
				...
				<small class="col s12 valign-wrapper" style="padding-top: .3rem;">
					<a href="" id="aircraft-details-page" class="blue-text text-darken-5" data-fleet-url="<?= site_url('fleet/showaircraft/'); ?>">
						<em><?= t('flash_lang_airc_comp_detail') ?></em>
					</a>
				</small>
